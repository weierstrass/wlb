...
void calcForce(CollisionD2Q9LPMChai1to1 *lpmcm, UnitHandlerLPM *lpmuh, UnitHandlerNS *lbmuh,
            Lattice2D *lm, double **fx, double **fy, double **ux, double **uy, double **psi,
            double lambda, double d, double dPdx);
...
int main(){
    ...
    for(int t = 0; t < t2Max; t++){
        ...
        calcForce(lpmcm, lpmuh, lbmuh, lm, fx, fy, uu[X], uu[Y], psi, lambda, d, dPdx);
