...
public:
	...
	void setCharLength(double l){charLength = l;};
	void setCharVoltage(double V){charVoltage = V;};
	void setTimeStep(double dt){this->dt = dt;};
	double getCharVoltage(){return charVoltage;};
	double getCharLength(){return charLength;};
