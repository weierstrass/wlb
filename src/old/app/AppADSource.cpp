...
void updateRho(double **rho_eps, CollisionD2Q9LNP *cmNPneg,
    CollisionD2Q9LNP *cmNPpos, LatticeModel *lm, double eps_r, double V0,
    double l0, double C0);

void initC(CollisionD2Q9LNP *cmNPneg, CollisionD2Q9LNP *cmNPpos,
    LatticeModel *lm);
...
int main() {
  ...
  double T = 293;
  double eps_r = 80;
  double rho_surface = -5e-2; //-50e-3*eps_r*PHYS_EPS0/1e-7/V0*l0;
